...
<template>
  <div class="flex flex-col justify-center items-center min-h-[500px] gap-2 px-8">
    <h1 class="text-3xl font-bold">Blog</h1>
    <p class="font-light">A place for my ideas, rants, and just about anything I can talk about</p>
  </div>
